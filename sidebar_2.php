...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
  ...
  <link rel="stylesheet" href="/assets/css/tb.min.css">

  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link href="https://fonts.googleapis.com/css2?family=Kanit:wght@200&display=swap" rel="stylesheet">
  <link rel="stylesheet" href="/assets/css/calendar.css">
  <link rel="stylesheet" href="/assets/css/btt.css">
  ...
  <link rel="stylesheet" href="/assets/modules/fullcalendar/fullcalendar.css">
...
<body>
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          <li><a href="#" class="nav-link nav-link-lg nav-link-user">
              <span id="user_name" class="w3-bar-item w3-right "></span></a>
          </li>
        </ul>
      </nav>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="#"><img src="/assets/img/WTC_logo.png" alt="#WTC" style="width: 130px; height: 60px;"></a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="#"><img src="/assets/img/WTC_logo.png" alt="#WTC" style="width: 60px; height: 30px;"></a>
          </div>
          <ul class="sidebar-menu">
            <li class="dropdown ">
              <a id="aDashboard" href="/index" class="nav-link b4"><i class="fas fa-chart-pie"></i><span>Dashboard</span></a>
            </li>
            <li class="dropdown">
              <a id="aNotify" href="#" class="nav-link has-dropdown b4" data-toggle="dropdown"><i class="fas fa-briefcase"></i><span>Serivce</span></a>
              <ul class="dropdown-menu">
                <li><a id="aNotify" class="nav-link b4" href="/service_tum">Tickets</a></li>
                <li><a id="aNotify" class="nav-link b4" href="/claim_repair_tum">Claim&Repair</a></li>
              </ul>
            </li>
            <!-- <li class="dropdown">
              <a id="aWarranty" href="/warranty" class="nav-link b4"><i class="	fas fa-shield-alt"></i> <span>MA Contract</span></a>
            </li>
            <li class="dropdown">
              <a id="aImplement" href="/implement" class="nav-link b4"><i class="	fas fa-cogs"></i> <span>Implement</span></a>
            </li> -->
            <li class="dropdown">
            <a id="aProject" href="/project" class="nav-link b4"><i class="fas fa-bookmark"></i><span>Project</span></a>
            </li>
            <li class="dropdown">
            <a id="aWarranty" href="/warranty_item" class="nav-link b4"><i class="fas fa-link"></i><span>Warranty</span></a>
            </li>
            <li class="dropdown">
              <a id="aPurchase" href="/purchase" class="nav-link b4"><i class="fas fa-shopping-cart"></i> <span>Purchase</span></a>
            </li>
            <li class="dropdown">
              <a id="aStock" href="/stock" class="nav-link b4"><i class="	fas fa-cubes"></i> <span>Stock</span></a>
            </li>
            <li class="dropdown">
              <a id="aRequest" href="/request" class="nav-link b4"><i class="fas fa-cube"></i> <span>Request</span></a>
            </li>
            <li class="dropdown">
              <a id="aLeadassign" href="/leadassign" class="nav-link b4"><i class="fas fa-envelope"></i> <span>Lead & Pipeline</span></a>
            </li>
            <li class="dropdown">
              <a id="aQuotation" href="/quotation_new" class="nav-link b4"><i class="far fa-file-alt"></i> <span>Sale</span></a>
            </li>
            <li class="dropdown">
              <a id="aCertificate" href="/certificate" class="nav-link b4"><i class="fas fa-award"></i> <span>Certificate</span></a>
            </li>
            <li class="dropdown">
              <a id="aDelivery" href="/delivery" class="nav-link b4"><i class="fas fa-shipping-fast"></i> <span>Delivery</span></a>
            </li>
            <li class="dropdown">
              <a id="aLeave" href="/leave" class="nav-link b4"><i class="fas fa-hand-paper"></i> <span>Leave Request</span></a>
            </li>
            <li class="dropdown">
              <a id="aTechnician" href="/job" class="nav-link b4"><i class="fas fa-wrench"></i> <span>Job</span></a>
            </li>
            <li class="dropdown">
              <a id="aUser" href="/user" class="nav-link b4"><i class="far fa-user"></i> <span>User</span></a>
            </li>
            <li class="dropdown">
            <a id="aMeeting" href="/meeting" class="nav-link b4" ><i class="fas fa-comments"></i><span>Meeting</span></a>
            </li>
            <li class="dropdown">
              <a id="aProfile" href="/profile" class="nav-link b4"><i class="far fa-id-card"></i> <span>Profile</span></a>
            </li>
          </ul>
  ...
  <script src="/assets/js/logoutpopup.js"></script>
