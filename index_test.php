    ...
    $.fn.get_ticket = function(startOfMonth , endOfMonth){
        $.post('./personal/get_graph.php', {
            ...
            if (data.length >0) {
                ...
                arr_data.push([new Date(startOfMonth), null, null, null ,null]);
                arr_data.push([new Date(endOfMonth), null, null, null ,null]);
    ...
    $.fn.get_claim = function(startOfMonth , endOfMonth){
        $.post('./personal/get_graph.php', {
            ...
            if (data.length >0) {
                ...
                console.log('sum_complete',sum_complete);
                console.log('sum_pending',sum_pending);
                console.log('sum_open',sum_open);
                console.log('sum_close',sum_close);
                console.log('sum_claim',sum_claim);
                console.log('sum_repair',sum_repair);
                console.log('sum_over_sla',sum_over_sla);
                console.log('sum_in_period',sum_in_period);
            }
        }, 'json');
        };
    ...
    $.fn.get_delivery = function(startOfMonth , endOfMonth){
        ...
        $.post('./personal/get_graph.php', {
            ...
            if (data.length >0) {
                ...
                $.each( data, function( index, arr ) {
                    arr_data.push([new Date(arr.s_date), parseFloat(arr.s_internal), parseFloat(arr.s_external), parseFloat(arr.s_walk_in)]);
                });
